<x-app-layout>
    <div>
        ...
        <x-form class="max-w-7xl mx-auto sm:px-2 lg:px-5" method="post" action="{{ route('gestion.pedido.store') }}">
            @include('gestion.pedido.partials._form', ['type' => 'store', 'submit_text' => 'Guardar'])
        </x-form>
    </div>
</x-app-layout>
